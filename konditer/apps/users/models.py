...
class User(AbstractUser):
    ...
    phone = models.CharField(max_length=13, unique=True, null=False, verbose_name=_('Номер телефона'))
    user_phone = models.CharField(max_length=13, unique=True, blank=True, null=True, verbose_name=_('Номер телефон пользователя'))
